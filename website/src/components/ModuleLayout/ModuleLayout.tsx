                  ...
                  {chapters.map((chapter, index) => (
                    <li key={chapter.id}>
                      <Link
                        ...
                        className="block p-3 rounded-lg bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors flex justify-between items-center"
                      >
                        <div>
